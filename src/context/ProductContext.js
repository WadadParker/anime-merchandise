...
export const ProductProvider=({children})=>
{
    const productReducer=(product,{type,payload})=>
    {
        switch(type)
        {
            ...
            case "CATEGORY_CHECK":
                ...
                return {...product,categoryCheck:{...categoryCheck,[payload]:!categoryCheck[payload]}};       
            
            case "SORT":
                return {...product,sort:payload};    

            case "CLEAR_FILTERS":
                return {...product,slider:0,categoryCheck:{oversize:false,winterWear:false,figurine:false,stickers:false},sort:""}    
    ...
    const initialState={
        slider:0,
        search:"",
        categoryCheck:{oversize:false,winterWear:false,figurine:false,stickers:false},
        sort:"",
        productList:[],
    }
